...
Eine Skizze des Messprinzips zur Bestimmung von $h$ mit Hilfe der Spannung $U_{\mathrm{Ph}}$ einer Photozelle ist in **Abbildung 2 (a)** gezeigt:
...
Der Ladevorgang beginnt bei $t=t_{0}$. Der genaue Verlauf der Kurve und insbesondere, wie steil sie zu Beginn Ansteigt hängt von der Kapazität $C$ des verwendeten Kondensators ab. 
...
\end{equation*}
$$
Lesen Sie $I_{\mathrm{Ph}}$ aus dem quasi-linearen Anstieg von $U(t)$ für $t\approx t_{0}$ ab, so lange die sich aufbauende Gegenspannung noch klein ist. Andernfalls bestimmen Sie $I_{\mathrm{Ph}}$ aus der Steigung der Tangente für $t\approx t_{0}$, wie in **Abbildung 3** gezeigt.

## Essentials

Was Sie ab jetzt wissen sollten:

- Sie sollten den äußeren **Photoeffekt erklären** können.
- Sie sollten das **Messprinzip erklären** können, nach dem Sie im Versuch $h$ mit Hilfe der Ladekurve eines Kondensators bestimmen werden.
- Sie sollten erklären können, **wie man aus der Ladekurve $I_{\mathrm{}Ph}$ bestimmen kann**.
...
1. Warum entläd sich das Elektrometer bei Bestrahlung mit Licht nicht, wenn es positiv aufgeladen ist?
1. Wie kommt es, dass Gleichung **(3)** ein gutes Modell zur Beschreibung des Ladevorgangs des Kondensators ist? 

...
Versuch **H18** (Stand: **April 2026**)

[Raum F1-14](https://labs.physik.kit.edu/img/Klassische-Praktika/Lageplan_P2.png)
...
- :white_check_mark: Sie wissen, wie man linear und elliptisch polarisiertes Licht erzeugt und untersucht.
- :white_check_mark: Sie kennen die optischen Eigenschaften von [Glimmer](https://de.wikipedia.org/wiki/Glimmergruppe). 
- :white_check_mark: Sie wissen, was es bedeutet, wenn ein Kristall **optisch positiv, biaxial doppelbrechenden** ist.
- :white_check_mark: Sie kennen mehrere Alltagsphänomene und mindestens zwei technische Anwendungen, die auf Doppelbrechung beruhen.
...
- Die folgenden Links führen auf/in die wichtigsten Dateien und Verzeichnisse dieser Versuchsanleitung:
  - [Polarisation.iypnb](https://gitlab.kit.edu/kit/etp-lehre/p2-praktikum/students/-/blob/main/Polarisation/Polarisation.ipynb): Aufgabenstellung und Vorlage fürs Protokoll (in Form eines Jupyter-notebook).
  - [Polarisation_Hinweise.ipynb](https://gitlab.kit.edu/kit/etp-lehre/p2-praktikum/students/-/blob/main/Polarisation/Polarisation_Hinweise.ipynb): Hinweise zu Versuchsdurchführung und Auswertung (in Form eines Jupyter-notebook).
  - [Datenblatt.md](https://gitlab.kit.edu/kit/etp-lehre/p2-praktikum/students/-/blob/main/Polarisation/Datenblatt.md): Inventar und technische Details zu den Versuchsaufbauten.

...
# Creating a list of points in x from -10 to 10 deg to display the functions of 
# choice
def plot(b=0.5*1e6/200, l=200, g=1e6/200, N=4):
    x = np.linspace(-10.2, 10.2, 2000)
    plt.plot(x, lattice(x=x/180*np.pi, b=b, l=l, g=g, N=N),
        color="black", 
        linestyle="solid",
        linewidth=1.5, 
        label=r"Intensität am Gitter"
        )
    plt.plot(x, lattice(x=x/180*np.pi, b=b, l=l, g=1., N=1),
        color="black", 
        linestyle="dashed",
        linewidth=1., 
    ...
    #plt.show()
# Example of usage with some reaonsalbe inputs
plot(b=0.5*1e6/200, l=200, g=1e6/200, N=4)

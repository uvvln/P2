 ...
 * Schließen Sie V2 bei einem Druck von $p_{\mathrm{RZ}}^{\mathrm{(T3)}}\lesssim10^{-4}\,\mathrm{mbar}$ und trennen Sie damit den RZ vom Rest der Apparatur ab. Dabei entspricht $p_{\mathrm{RZ}}^{\mathrm{(T3)}}$ dem bei T3 angezeigten Druck. Sie können die TMP daraufhin abschalten. 
   ...
   * **Schritt 2:** Schließen Sie V3 und öffnen Sie daraufhin B2, damit sich im kleineren Referenzvolumen (RV [hier](https://gitlab.kit.edu/kit/etp-lehre/p2-praktikum/students/-/blob/main/Vakuum/figures/VakuumSkizze.png)) erneut Atmosphärendruck ($p_{0}$) einstellen kann. **Warten Sie den Druckausgleich im Gleichgewichtszustand ab!**

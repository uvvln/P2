...
\end{equation}
$$
Das Minuszeichen in Gleichung **(4)** zeigt, dass $\dot{V}$ der Druckdifferenz entgegen gerichtet ist, d.h. das Fluid fließt in Richtung des geringeren Drucks. Gleichung **(4)** bezeichnet man als das **Gesetz von Hagen-Poisseuille**. Demnach gilt entlang der Stömungsrichtung $x$: 
$$
\begin{equation*}
...
- Man unterscheidet **drei Vakuumbereiche**, Grob-, Fein- und Hochvakuum, je nachdem welche Wechselwirkungen den Fluss des Fluids bestimmen.

...
Er ähnelt bis auf einige Details dem Aufbau des Gasthermometers aus **Abbildung 1** [hier](https://gitlab.kit.edu/kit/etp-lehre/p2-praktikum/students/-/blob/main/Ideales_und_reales_Gas/doc/Hinweise-Gasthermometer.md). In einem Kolben K befindet sich das zu untersuchende n-Hexan in einem Wärmebas W, dessen Temperatur Sie durch Zufuhr von zerstoßenem Eis oder geringen Wasser kontrollieren können. An K schließt sich ein Hg-Barometer an, das (in der Abbildung oben links), abgeschlossen ist. Wir gehen zunächst von Raumtemperatur 
$$
\begin{equation*}
...
An einem Aufbau (**V163**) können Sie feststellen, dass n-Hexan in das Volumen V eingedrungen ist. Für diesen Aufbau ist Gleichung **(5)** wie folgt zu modifizieren:
$$
\begin{equation}
...
- Sie sollten in der Lage sein zu **erklären was Dampfdruck ist**.
- Sie sollten eine **Erwartung für den Dampfdruck von n-Hexan** bei Raumtemperatur haben.
- Sie sollten eine Vorstellung davon haben, ob der Dampfdruck von n-Hexan mit zunehmender Temperatur **steigt oder sinkt**. 

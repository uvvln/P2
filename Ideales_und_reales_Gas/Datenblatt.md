...
[n-Hexan](https://www.unternehmensberatung-babel.de/industriegase-lexikon/kohlenwasserstoffe/hexan/index.html) hat die folgenden Eigenschaften, die für diesen Versuch von Relevanz sind [[4](https://de.wikipedia.org/wiki/Hexane)]:
...
- Dichte (bei $20^{\circ}\mathrm{C}$): $\rho=13.5459\ \mathrm{g/cm^{3}}$ [[2](https://de.wikipedia.org/wiki/Quecksilber)].
- Dampfdruck (bei $20^{\circ}\mathrm{C}$): $p_{\mathrm{Hg}}=0.00163\ \mathrm{mbar}$ [[3](https://de.wikipedia.org/wiki/Quecksilber)].
- Siedetemperatur: $T_{s}=630.2\ \mathrm{K};\ \vartheta_{s}=357.05^{\circ}\mathrm{C}$ [[2](https://de.wikipedia.org/wiki/Quecksilber)].

Zudem sollten die folgenden Größen für Sie von Relevanz sein:

- Absoluter Nullpunkt der Temperatur: $\vartheta_{0} = -273.15^{\circ}\mathrm{C}$ [[1](https://de.wikipedia.org/wiki/Absoluter_Nullpunkt)].
- Erdbeschleunigung: $(9.809599±0.000034)\ \mathrm{m/s^{2}}$ [[5](https://ggos.org/item/bgi/)].
- Ideale Gaskonstante: $8.31446261815324\ \mathrm{J/mol/K}$ [[6](https://de.wikipedia.org/wiki/Gaskonstante)]. 
